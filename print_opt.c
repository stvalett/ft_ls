...
/*   Updated: 2017/01/23 18:30:10 by stvalett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_size(t_dir *dir, int size)
{
	...
	i = ft_lendigit((int)dir->info.st_size);
	while (i < size)
	{
		write(1, " ", 1);
		i++;
...
void	print_lnk(t_dir *dir, int size)
{
	...
	i = ft_lendigit((int)dir->info.st_nlink);
	while (i++ < size)
		write(1, " ", 1);
